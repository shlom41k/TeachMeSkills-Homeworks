class Transport:
    ...
    def __init__(self, brand: str, max_speed: int, kind=None):
        self.brand = brand
...
class Car(Transport):
    ...
    def __init__(self, brand: str, max_speed: int, mileage: int, gasoline_residue: int):
        super().__init__(brand=brand, max_speed=max_speed, kind="Car")
...
class Boat(Transport):
    ...
    def __init__(self, brand: str, max_speed: int, owners_name: str):
        super().__init__(brand=brand, max_speed=max_speed, kind="Boat")
...
class Plane(Transport):
    ...
    def __init__(self, brand: str, max_speed: int, capacity: int):
        super().__init__(brand=brand, max_speed=max_speed, kind="Plane")
